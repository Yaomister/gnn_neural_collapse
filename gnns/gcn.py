...
class GCN(Module):
    ...
    num_hidden_layers GCNConv layers with ReLU activations (except the last layer), applies global pooling to obtain a graph-level representation, then classifies with a
